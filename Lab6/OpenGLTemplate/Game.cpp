...
void Game::Render() 
{
	...
	pSphereProgram->SetUniform("light1.La", glm::vec3(255, 0, 255));	pSphereProgram->SetUniform("light1.Ld", glm::vec3(255, 0, 255));
	pSphereProgram->SetUniform("light1.Ls", glm::vec3(255, 0, 255));
	...
	for (auto x = 0; x < 11; ++x) 
	{
		for (auto z = 0; z < 11; ++z) 
		{
			// Render the sphere
			modelViewMatrixStack.Push();
			modelViewMatrixStack.Translate(glm::vec3(x * 10.0f, 5.0f, z * 10.0f));
